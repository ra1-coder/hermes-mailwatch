...
Install (as root or the hermes user):
    ...
    # [15 Jul 2026: Telegram delivery retired repo-wide, see commit 0f1bb6f —
    # daemon now posts to Discord. Do not reintroduce TELEGRAM_* vars here.]
...
The .service file does not apply. Instead, in any writable workspace dir:
    ...
    # create mailwatch.env next to them with: GMAIL_USER, GMAIL_APP_PASSWORD,
    # ANTHROPIC_API_KEY, SUPABASE_URL, SUPABASE_SERVICE_ROLE_KEY,
    # DISCORD_BOT_TOKEN, DISCORD_CHANNEL_ID
...
- ANTHROPIC_API_KEY / DISCORD_BOT_TOKEN / DISCORD_CHANNEL_ID — the agent
